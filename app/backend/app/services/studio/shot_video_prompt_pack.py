...
def _pack_variables(pack: ShotVideoPromptPackRead) -> dict[str, Any]:
    ...
    return {
        ...
        "shot_description": pack.shot_description,
        ...
        "narrative_function": pack.narrative_function,
        "sound_effects": pack.sound_effects,
        "has_bgm": pack.has_bgm,
...
async def build_shot_video_prompt_pack(
    ...
    *,
    ...
    return ShotVideoPromptPackRead(
        ...
        dialogue_summary=dialogue_summary,
        narrative_function=str(getattr(detail, "narrative_function", "") or ""),
        sound_effects=str(getattr(detail, "sound_effects", "") or ""),
        has_bgm=bool(getattr(detail, "has_bgm", False)),
