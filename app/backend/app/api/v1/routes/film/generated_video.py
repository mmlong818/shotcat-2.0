...
from app.schemas.studio.shots import ShotVideoPromptPackRead, VideoExecutionPlanRead
...
class VideoPromptPreviewResponse(BaseModel):
    ...
    execution_plan: VideoExecutionPlanRead | None = Field(None, description="完整视频执行计划")
